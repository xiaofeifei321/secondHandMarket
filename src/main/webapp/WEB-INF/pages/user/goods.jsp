                        ...
                        <c:forEach var="items" items="${goodsAndImage}">
                            <div class="story">
                                ...
                                <div class="box">
                                    ...
                                    <div class="interact">
                                        <span class=" fa  glyphicon glyphicon-sort fa-lg"><a href="<%=basePath%>user/changeGoods/">交换</a></span>
                                        <span class="fa fa-edit fa-lg"><a href="<%=basePath%>goods/editGoods/${items.goods.id}">编辑</a></span>
                                        <span class="fa fa-share fa-lg"><a href="<%=basePath%>goods/polishGoods/${items.goods.id}">擦亮</a></span>
