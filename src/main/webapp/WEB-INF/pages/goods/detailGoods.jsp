    ...
    <nav class="white nav1">
        <div class="nav-wrapper">
            <a href="<%=basePath%>goods/homeGoods" class="logo">
                <em class="em1">岭南师范学院</em>
                <em class="em2">二手工坊</em>
                <em class="em3">ptu.market</em>
            </a>
...
<div ng-controller="detailBoxController" class="detail-box stark-components z-depth-1 row ng-scope">
    ...
    <div class="col s6">
        ...
        <div class="item-public-info">
            <p>
                <i class="iconfont"></i>
                <em class="item-location">北理工学院</em>
            </p>
        </div>
                ...
                <div>
                    ...
                    <c:if test="${!empty flag}">
                        <c:if test="${cur_user.id==goodsExtend.goods.userId}">
                            <input type="button" value="二手互换" data-toggle="tooltip" title="不可以互换自己的东西哦~"
                                   disabled="disabled" class="blue lighten-1 waves-effect waves-light btn"
                                   id="btn_buy"></input>
                        </c:if>
                        <c:if test="${cur_user.id!=goodsExtend.goods.userId}">
                            <input type="button" value="立刻互换" class="blue lighten-1 waves-effect waves-light btn"
